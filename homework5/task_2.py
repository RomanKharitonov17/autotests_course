...
def repeats(our_str):
    """Добавляет количество повторений символа в строке с помощью постфикса _n.
       :param: our_str - входящая строка.
       :return: new_str - строка с постфиксом _n после каждого символа, где n - количество повторений символа в строке.
    """
    new_str = ""
    num_dict = {}
    for i in our_str:
